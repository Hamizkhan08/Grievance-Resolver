                ...
                >
                  {complaint.time_remaining_hours !== null
                    ? complaint.time_remaining_hours > 0
                      ? `${Math.floor(complaint.time_remaining_hours / 24)} ${t(
                          "days"
                        )}, ${Math.floor(
                          complaint.time_remaining_hours % 24
                        )} ${t("hours")}`
                      : t("statusOverdue")
                    : t("statusNA")}
                </span>
            ...
            {complaint.escalation_level !== "none" && (
              <div className="detail-card escalation-notice">
                ...
                <div>
                  ...
                  <span className="detail-value">
                    {complaint.escalation_level.replace("_", " ").toUpperCase()}
                  </span>
                </div>
              </div>
            )}
            ...
            <div className="detail-card">
              ...
              <span className="detail-value">
                ...
                <small style={{ color: "var(--text-secondary)" }}>
                  {formatDistanceToNow(new Date(complaint.last_update), {
                    addSuffix: true,
                  })}
                </small>
              </span>
