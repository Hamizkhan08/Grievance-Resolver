...
const Heatmap = () => {
  ...
  const fetchHeatmapData = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/api/heatmap/data`, {
        params,
      });
    ...
    <div className="heatmap">
      <div className="heatmap-header">
        <div>
          ...
          <p>
            {t("heatmapSubtitle") ||
              "Complaint density, categories, and resolution times by location"}
          </p>
        </div>
      ...
      {heatmapData && (
        <>
            ...
            <div className="summary-card">
              ...
              <div>
                ...
                <span className="summary-value">
                  {heatmapData.summary?.total_locations || 0}
                </span>
              </div>
            </div>
            <div className="summary-card">
              ...
              <div>
                ...
                <span className="summary-value">
                  {heatmapData.summary?.total_complaints || 0}
                </span>
              </div>
            </div>
            <div className="summary-card">
              ...
              <div>
                ...
                <span className="summary-value">
                  {heatmapData.summary?.total_categories || 0}
                </span>
              </div>
            </div>
            <div className="summary-card">
              ...
              <div>
                ...
                <span className="summary-value">
                  {heatmapData.summary?.total_departments || 0}
                </span>
              </div>
            </div>
          </div>
                  ...
                  <div className="location-stats">
                    ...
                    {location.avg_resolution_hours && (
                      <div className="stat-item">
                        ...
                        <span className="stat-value">
                          {Math.round(location.avg_resolution_hours / 24)}{" "}
                          {t("days") || "days"}
                        </span>
                      </div>
                    )}
                    {location.sentiment_avg !== 0 && (
                      <div className="stat-item">
                        ...
                        <span
                          ...
                          style={{
                            color: getSentimentColor(location.sentiment_avg),
                          }}
                        >
                          {location.sentiment_avg > 0 ? "+" : ""}
                          {location.sentiment_avg.toFixed(2)}
                        </span>
                      </div>
                    )}
                  </div>
          ...
          {/* Top Categories */}
          {heatmapData.top_categories &&
            heatmapData.top_categories.length > 0 && (
              <div className="heatmap-section">
                      ...
                      <div className="bar-container">
                        <div
                          ...
                          style={{
                            width: `${
                              (item.count /
                                heatmapData.top_categories[0].count) *
                              100
                            }%`,
                          }}
                        >
          ...
          {/* Department Stats */}
          {heatmapData.department_stats &&
            Object.keys(heatmapData.department_stats).length > 0 && (
              <div className="heatmap-section">
                <h2>
                  {t("resolutionTimesByDepartment") ||
                    "Average Resolution Times by Department"}
                </h2>
                <div className="department-stats-grid">
                  {Object.entries(heatmapData.department_stats).map(
                    ([dept, stats]) => (
                      <div key={dept} className="department-stat-card">
                        ...
                        <div className="stat-row">
                          ...
                          <span className="stat-value">
                            {Math.round(stats.avg_resolution_hours / 24)}{" "}
                            {t("days") || "days"}
                          </span>
                        </div>
                        <div className="stat-row">
